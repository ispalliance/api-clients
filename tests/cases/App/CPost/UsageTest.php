...
namespace Tests\Cases\App\CPost;
...
use Tests\Cases\App\CPost\XmlRequest\ConsignmentRequestFactoryTest;
...
final class UsageTest extends TestCase
{
	...
	protected function setUp(): void
	{
		...
		$guzzle = (new GuzzleFactory($config))->create('cpost');
		$client = new ConsignmentClient($guzzle, $config['app']['cpost']);
